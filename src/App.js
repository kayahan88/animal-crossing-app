...
// import IslandItems from './Components/IslandItems';
// import PocketItems from './Components/PocketItems';
...
function App() {
  return (
    <div className='background'>
      <Header />
      <section>
        <div className='pockets-inventory-container'>
